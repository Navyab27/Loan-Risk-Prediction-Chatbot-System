...
def test_case(loan_amnt, int_rate, annual_inc, dti, term, grade):
...
print("Low:", test_case(10000, 9, 85000, 10, 36, 'A')["default_probability"])
print("Medium:", test_case(20000, 16, 50000, 25, 60, 'D')["default_probability"])
print("High:", test_case(40000, 28, 20000, 42, 60, 'G')["default_probability"])
